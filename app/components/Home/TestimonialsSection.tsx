...
const bestsellers = [
  ...
  },
  {
    ...
    name: 'Modern Emerald',
    price: '$22,750',
    image: 'https://images.unsplash.com/photo-1596944946094-0f47c48df3e4?w=300&h=300&fit=crop',
  ...
  },
  {
    ...
    price: '$15,400',
    image: 'https://images.unsplash.com/photo-1588444650733-de72c75ad2d6?w=300&h=300&fit=crop',
        ...
        <div className="mb-20">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-[hsl(var(--muted-foreground))] font-luxury-sans text-lg max-w-2xl mx-auto">
              Every ring tells a story. Here are some stories from our happy couples.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {testimonials.map((testimonial) => (
              <Card key={testimonial.id} className="card-luxury p-6 text-center space-y-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {bestsellers.map((ring) => (
              <Card key={ring.id} className="card-luxury overflow-hidden group cursor-pointer">
